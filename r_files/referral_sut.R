...
plotSingleClientReferralJourney <- function(dataset) {
...
# Display for example dataset
dataset <- read.csv("dummy_dataset_referrals_contacts_sut.csv") %>% 
  mutate(Date=lubridate::dmy(Date),
         EndDate = lubridate::dmy(EndDate))

plotSingleClientReferralJourney(dataset)  
